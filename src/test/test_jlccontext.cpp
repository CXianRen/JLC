...
{
    {
        ...
        TEST_ASSERT(ctx.has_enum("enum_name"));
        TEST_ASSERT(!ctx.has_enum("enum_name2"));
    ...
    }
    {
        ...
        TEST_ASSERT(ctx.has_struct("struct_name"));
        TEST_ASSERT(!ctx.has_struct("struct_name2"));
    ...
    }
    {
        ...
        TEST_ASSERT(ctx.has_class("class_name"));
        TEST_ASSERT(!ctx.has_class("class_name2"));
    ...
    }
    {
        ...
        TEST_ASSERT(ctx.has_func("func_name"));
        TEST_ASSERT(!ctx.has_func("func_name2"));
